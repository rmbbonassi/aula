...
const mockContatos: Contato[] = [
  { id: '1', cliente_id: 'c1', nome: 'João Silva', cargo: 'Diretor', email: 'joao@company.com', telefone: null, created_at: '2026-01-01T10:00:00Z', criado_por: null },
]
...
describe('ContatosSection', () => {
  ...
  it('adds a new contact on form submit', async () => {
    mockSingle.mockResolvedValue({ data: { id: '2', cliente_id: 'c1', nome: 'Maria', cargo: null, email: null, telefone: null, created_at: new Date().toISOString(), criado_por: null }, error: null })
    const { default: ContatosSection } = await import('@/components/contatos-section')
    render(<ContatosSection clienteId="c1" initialContatos={[]} />)
